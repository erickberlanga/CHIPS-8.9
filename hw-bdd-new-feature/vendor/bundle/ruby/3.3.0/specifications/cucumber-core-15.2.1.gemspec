# -*- encoding: utf-8 -*-
# stub: cucumber-core 15.2.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.summary = "cucumber-core-15.2.1".freeze

  s.installed_by_version = "3.6.3".freeze

  s.specification_version = 4

  s.add_runtime_dependency(%q<cucumber-gherkin>.freeze, ["> 27".freeze, "< 33".freeze])
  ...
  s.add_development_dependency(%q<rubocop>.freeze, ["~> 1.77.0".freeze])
